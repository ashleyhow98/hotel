<div class="account-container" style="margin: 0 auto;">
	...
	<div class="content clearfix">
		...
		<form action="<?php echo base_url(); ?>room/add" method="post">
			...
			<h1>Edit guest in one room report</h1>		
<?php if(isset($error)) {?>
...
<?php } ?>
			...
			<div class="add-fields">
				...
				<div class="field">
					<label for="max_id">First Name:</label>
					<input type="number" min="1" id="max_id" name="max_id" value="" placeholder="-"/>
				</div> <!-- /field -->

				<div class="field">
					<label for="max_id">Last Name:</label>
					<input type="number" min="1" id="max_id" name="max_id" value="" placeholder="-"/>
				</div> <!-- /field -->
				
				<div class="field">
					<label for="max_id">Phone:</label>
					<input type="number" min="1" id="max_id" name="max_id" value="" placeholder="-"/>
				</div> <!-- /field -->
				
				<div class="field">
					<label for="max_id">Gender:</label>
					<input type="number" min="1" id="max_id" name="max_id" value="" placeholder="-"/>
				</div> <!-- /field -->
