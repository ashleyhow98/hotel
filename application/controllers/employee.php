...
class Employee extends CI_Controller {
	...
	public function add()
	{
		...
		if($this->input->post("username") && $this->input->post("password") && $this->input->post("bca"))
		{
			...
			$employee_date_of_birth = $this->input->post("employee_date_of_birth");
			
			$this->employee_m->addEmployee($username, $password, $firstname, $lastname, $telephone, $bca, $employee_type, $employee_address, $employee_date_of_birth);
			redirect("/employee");
		}
